...
本文档是个人的学习和开发记录文档，仅限学习交流和参考。主题涉及 iOS 移动应用开发、Web开发、计算机和编程基础，以及一些常用的工具/资源的分享。为了更好的代码阅读体验，推荐使用 Chrome / Firefox / Edge 浏览器打开。欢迎访问我的 [主页](https://italkso.github.io)了解更多内容。
...
[Apple 官方框架：传感器框架 Core Motion](ios/swift/cm.md) 

[Apple 官方框架：本地身份认证框架 Local Authentication](ios/swift/la.md)

[Apple 官方框架：地理位置服务框架 Core Location](ios/swift/corelocation.md)
